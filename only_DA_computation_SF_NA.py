...
for i in range(num_times):
	...
	(GC_List, SGC_List, num_comp_List, original_degree_list,adaptive_degree_list) = DA_attack(G, int(N * 0.9))
	...
	original_degree_list_name = get_name_SF(init_name_original_degree_list, N,k,exp_out,SEED,radius)
	adaptive_degree_list_name = get_name_SF(init_name_adaptive_degree_list, N,k,exp_out,SEED,radius)
