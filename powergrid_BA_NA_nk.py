...
(GC_List, SGC_List, num_comp_List, avg_comp_size_List) = BA_attack(G, int(N * 0.9))

init_name_GC_DEG = adaptive_type + "SGCattackBETNK_" + type_graph +"_GC"

init_name_SGC_DEG = adaptive_type + "SGCattackBETNK_" + type_graph +"_SGC"

init_name_numComp_DEG = adaptive_type + "SGCattackBETNK_" + type_graph +"_numberOfComponents"

init_name_avgSize_DEG = adaptive_type + "SGCattackBETNK_" + type_graph +"_avgComponents"
