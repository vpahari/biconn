...
for i in range(num_times):
	...
	original_degree_main_node_name = get_name_SF(init_name_original_degree_main_node, N, k,exp_out, SEED, radius)
	original_degree_removed_node_name = get_name_SF(init_name_original_degree_removed_node, N, k,exp_out, SEED, radius)

	original_xi_values_name = get_name_SF(init_name_original_xi_values, N, k,exp_out, SEED, radius)
