...
def big_RA_attack(G_copy,num_nodes_to_remove,num_sims):
	...
	for i in range(num_sims):
		...
		(GC_List, SGC_List, num_comp_List,avg_comp_size) = RA_attack(G_copy,num_nodes_to_remove)

		big_GC_List.append(GC_List)
		big_SGC_List.append(SGC_List)
		big_numComp_List.append(num_comp_List)
		big_avg_comp_List.append(avg_comp_size)
...
for i in range(num_times):
	...
	(GC_List, SGC_List, num_comp_List, avg_comp_size_List)  = big_RA_attack(G, int(N * 0.99), 1)

	init_name_GC_DB = adaptive_type + "SGCattackRA_" + type_graph +"_GC"

	init_name_SGC_DB = adaptive_type + "SGCattackRA_" + type_graph +"_SGC"

	init_name_numComp_DB = adaptive_type + "SGCattackRA_" + type_graph +"_numberOfComponents"

	init_name_avgSize_DB = adaptive_type + "SGCattackRA_" + type_graph +"_avgComponents"
