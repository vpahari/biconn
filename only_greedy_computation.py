...
def greedy_attack(G_copy, num_nodes_to_remove):
...
for i in range(num_times):
	...
	(GC_List, SGC_List, num_comp_List,avg_comp_size_List) = greedy_attack(G, int(N * 0.9))

	init_name_GC_DEG = adaptive_type + "SGCattackGREEDY_" + type_graph +"_GC"

	init_name_SGC_DEG = adaptive_type + "SGCattackGREEDY_" + type_graph +"_SGC"

	init_name_numComp_DEG = adaptive_type + "SGCattackGREEDY_" + type_graph +"_numberOfComponents"

	init_name_avgSize_DEG = adaptive_type + "SGCattackGREEDY_" + type_graph +"_avgComponents"
