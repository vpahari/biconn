...
for alpha in alpha_list:
	...
	for k_inter in kinter_list:
		...
		for i in range(num_times):
			...
			(GC_List, SGC_List, num_comp_List, avg_comp_size_List,connected_removed_nodes, label_list) = BA_attack_igraph(G, int(N * 0.9),set_of_connected_nodes)
			...
			init_name_label_list = adaptive_type + "SGCattackBET_" + type_graph + "_labels"
