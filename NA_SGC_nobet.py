...
def get_results_NA(G, radius):
	...
	return (GC_List_DA, SGC_List_DA, num_comp_List_DA, original_degree_list,adaptive_degree_list, avg_list_GC_RAN, avg_list_SGC_RAN, avg_list_numComp_RAN,GC_List_DB, SGC_List_DB, num_comp_List_DB, counter_list,size_dball,size_ball,degree_list_mainNode,betweenness_list_mainNode,coreness_list_mainNode,degree_list_removedNode,betweenness_list_removedNode,coreness_list_removedNode)
...
for i in range(num_times):
	...
	init_name_bet_mainNode = adaptive_type + "SGCattackDB_ER_betMainNode"
	init_name_bet_removedNode = adaptive_type + "SGCattackDB_ER_betRemovedNode"

	init_name_core_mainNode = adaptive_type + "SGCattackDB_ER_coreMainNode"
	init_name_core_removedNode = adaptive_type + "SGCattackDB_ER_coreRemovedNode"
