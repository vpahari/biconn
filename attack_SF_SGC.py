...
for i in range(num_times):
	...
	init_name_GC_Deg = "SGCattackDEG_SF_GC"
	init_name_GC_Bet = "SGCattackBET_SF_GC"
	init_name_GC_Ran = "SGCattackRAN_SF_GC"
	init_name_GC_DB = "SGCattackDB_SF_GC"

	init_name_dball = "SGCattackDB_SF_DBALL"
	init_name_ball = "SGCattackDB_SF_BALL"

	init_name_CL = "SGCattackDB_SF_CL"

	init_name_deg_mainNode = "SGCattackDB_SF_degMainNode"
	init_name_deg_removedNode = "SGCattackDB_SF_degRemovedNode"

	init_name_bet_mainNode = "SGCattackDB_SF_betMainNode"
	init_name_bet_removedNode = "SGCattackDB_SF_betRemovedNode"
	...
	init_name_SGC_Ran = "SGCattackRAN_SF_SGC"
	init_name_SGC_DB = "SGCattackDB_SF_SGC"

	init_name_numComp_Deg = "SGCattackDEG_SF_numberOfComponents"
	init_name_numComp_Bet = "SGCattackBET_SF_numberOfComponents"
	init_name_numComp_Ran = "SGCattackRAN_SF_numberOfComponents"
	init_name_numComp_DB = "SGCattackDB_SF_numberOfComponents"
	...
	degree_list_name = get_name_SF(init_degree_list_name, N, k, exp_out,SEED, radius)

	SGC_DEG_name = get_name_SF(init_name_SGC_Deg, N, k, exp_out,SEED, radius)
	SGC_BET_name = get_name_SF(init_name_SGC_Bet, N, k, exp_out,SEED, radius)
	SGC_RAN_name = get_name_SF(init_name_SGC_Ran, N, k, exp_out,SEED, radius)
	...
	numComp_BET_name = get_name_SF(init_name_numComp_Bet, N, k, exp_out,SEED, radius)
	numComp_RAN_name = get_name_SF(init_name_numComp_Ran, N, k, exp_out,SEED, radius)
