...
def make_modular_network_ER(N,k_intra,k_inter,num_modules,SEED,alpha):
	...
	(G_nk, set_of_connected_nodes) = make_graphs_into_one_multiple_graphs_alpha(list_Graphs,num_edges,alpha)
...
def create_graphs_degree(G, position,path):
	...
	init_filename = "MOD_N_" + str(N) + "_kintra_" + str(k_intra) + "_kinter_" + str(k_inter) + "_numMod_" + str(num_modules) + "_radius_" + str(radius) + "_numBalls_"
...
path = os.getcwd() + "/" + "MOD_N_" + str(N) + "_kintra_" + str(k_intra) + "_kinter_" + str(k_inter) + "_alpha_" + str(alpha) + "_numMod_" + str(num_modules) + "/"

filename = "MOD_N_" + str(N) +  "_kintra_" + str(k_intra) + "_kinter_" + str(k_inter) + "_alpha_" + str(alpha) + "_numMod_" +  str(num_modules) +  ".png"
