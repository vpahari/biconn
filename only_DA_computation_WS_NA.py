...
for i in range(num_times):
	...
	avgComp_DEG_name = get_name_WS(init_name_avgSize_DEG, dim, N, nei, p, SEED,radius)

	original_degree_list_name = get_name_WS(init_name_original_degree_list, dim, N, nei, p, SEED,radius)
	adaptive_degree_list_name = get_name_WS(init_name_adaptive_degree_list, dim, N, nei, p, SEED,radius)
