...
for i in range(num_times):
	...
	init_name_GC_RAN = adaptive_type + "SGCattackRAN_" + type_graph +"_GC"

	init_name_SGC_RAN = adaptive_type + "SGCattackRAN_" + type_graph +"_SGC"
	...
	SGC_name = get_name_WS(init_name_SGC_RAN, dim, N, nei, p, SEED,radius)

	numComp_name = get_name_WS(init_name_numComp_RAN, dim, N, nei, p, SEED,radius)

	avgSize_name = get_name_WS(init_name_avgSize_RAN, dim, N, nei, p, SEED,radius)
